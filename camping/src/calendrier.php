...
if($retour === '/camping/src/calendrier.php')
{
...
$req="SELECT date_debut, type FROM reservations WHERE id_emplacement='$idemplacement'";
...
$req_date_debut="SELECT date_debut, type, id FROM reservations WHERE id_emplacement='$idemplacement'";
...
$type=$_SESSION['type'];
$base= mysqli_connect("localhost", "root", "", "camping");
$req_date_fin="SELECT date_fin FROM reservations WHERE id_emplacement='$idemplacement'";
...
{
?>
<form action="reservation.php?mois2=<?php echo $_GET['mois2'];?>&annee2=<?php echo $_GET['annee2'];?>&mois=<?php echo $_GET['mois'];?>&annee=<?php echo $_GET['annee'];?>" method="post">
<?php
}
else
{
?>
<form action="reservation.php?mois=<?php echo $_GET['mois'];?>&annee=<?php echo $_GET['annee'];?>" method="post">	
<?php
}
}
...
{
?>
<form action="reservation.php?mois2=<?php echo $_GET['mois2'];?>&annee2=<?php echo $_GET['annee2'];?>" method="post">
<?php
}
else
{
...
{
?>
<form action="reservation.php?mois=<?php echo $_GET['mois'];?>&annee=<?php echo $_GET['annee'];?>&mois2=<?php echo $_GET['mois2'];?>&annee2=<?php echo $_GET['annee2'];?>" method="post">
<?php
}
else
{
